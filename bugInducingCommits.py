...
commit_sha = []
with open('netdataClosedBuggyCommits.csv', encoding="ISO-8859-1") as csvfile:
    readCSV = csv.reader(csvfile, delimiter=',')
    with open('netdataBugInducingCommits.csv', 'w') as csvOut:
        ...
        for row in list(readCSV):
            ...
            for commit in RepositoryMining('/home/mmm/Projects/netdata', only_commits=row[0]).traverse_commits():
                #print(commit)
                BuggyCommit = GitRepository("/home/mmm/Projects/netdata").get_commits_last_modified_lines(commit)
                print(BuggyCommit)
